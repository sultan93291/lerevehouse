...
const WhyBookSection = forwardRef(({ ...props }, ref) => {
  ...
  return (
    <section
      ...
      {...props}
      id="tour"
      className=" lg:py-14 2xl:py-28 container mx-auto px-4 lg:px-8 2xl:px-16 3xl:px-32   "
    >
      <div>
      ...
      {/* cards */}
      <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-12 my-16">
        {cardInfo?.map(info => (
