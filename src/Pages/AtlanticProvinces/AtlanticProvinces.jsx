  ...
  return (
    <section className=" mt-10 flex flex-col">
      <CommonHeroBanner
        ...
        italic={false}
        subTittle={
          "Fairytale landscapes, colorful houses, postcard lighthouses but also wild spirit, freezing seas and very hospitable people!"
        }
        bg={atlantic}
      />
...
export default AtlanticProvinces;
