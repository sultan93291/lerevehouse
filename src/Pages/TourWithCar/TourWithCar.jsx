            ...
            <div className="flex flex-col gap-y-[60px] ">
              <div className="flex flex-row justify-between  ">
                ...
                <button
                  ...
                  className="px-[61px] py-5 rounded-[5px] bg-[#1687C7] text-xs font-medium leading-[120%] font-interTight text-white border-[1px] border-transparent ease-in-out duration-500 hover:bg-transparent hover:border-solid hover:border-[#1687C7] hover:text-[#1687C7]"
                >
                  Make An Enquiry
                </button>
              </div>
