...
const CommonHeroBanner = ({
  ...
  return (
    <section
      className="h-[600px] mt-24 bg-cover bg-center flex flex-col gap-10 items-center justify-center"
      style={{
    ...
    >
      <h1 className="text-6xl font-editorsNoteNormal font-light text-white ">
