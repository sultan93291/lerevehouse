    ...
    <div className="px-4 py-5 font-interTight group bg-[#f4f4f4]">
      ...
      <div className="mt-4 space-y-3 ">
        ...
        <div className="space-y-1">
          ...
          <p className="text-[#565656] h-20">
            {item?.description}
            <Link className="text-primary">Read More</Link>
          </p>
        </div>
        <div className="w-full flex items-center justify-between pt-3">
          <span className="text-primary font-semibold">€2,650.00</span>
          <Link
            to={`/tour-list-details/${item?.id}`}
            className="bg-primary px-4 py-2 text-white text-sm border border-primary hover:bg-transparent hover:text-primary transition-all duration-300"
          >
            VIEW THIS TOUR
          </Link>
        </div>
