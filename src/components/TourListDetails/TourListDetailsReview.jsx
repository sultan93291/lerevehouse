    ...
    <div className="my-20">
      ...
      <div className="mt-10 relative">
        ...
        <button
          ...
          className="size-8 bg-transparent shadow-md rounded-full flex items-center justify-center absolute top-1/2 -left-10 z-20 group hover:bg-primary transition-all duration-300 -translate-y-1/2 border border-[#9C9EA1]"
        >
          <PrevArrowTourListDetailsSvg />
        </button>
        <button
          onClick={() => swiperRef.slideNext()}
          className="size-8 bg-transparent shadow-md rounded-full flex items-center justify-center absolute top-1/2 -right-10 z-20 group hover:bg-primary transition-all duration-300 -translate-y-1/2 border border-[#9C9EA1]"
        >
          <NextArrowTourListDetailsSvg />
        </button>
      </div>
      ...
      <div className="py-6 w-full flex items-center justify-center">
        <p className="font-interTight text-text-gray flex items-center gap-1">
          Rated <span className="text-primary font-semibold">4.8</span> out of 5
          based on
          <span className="text-primary font-semibold">2965 review</span> on
          <span><TourListDetailsBottomStarSvg /></span>
