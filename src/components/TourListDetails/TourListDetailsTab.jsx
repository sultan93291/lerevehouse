...
const TourListDetailsTab = ({ sectionTabs }) => {
  ...
  return (
    <div className="py-4 2xl:sticky z-[600] top-[152px] left-0 font-interTight w-full bg-[#f4f4f4] flex flex-row flex-wrap items-center lg:justify-center gap-3 3xl:gap-12  ">
