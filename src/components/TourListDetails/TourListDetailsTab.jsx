...
const TourListDetailsTab = ({ sectionTabs }) => {
  ...
  return (
    <div className="py-4 2xl:sticky z-[600] top-[152px] left-0 font-interTight w-full bg-[#f4f4f4] flex flex-row flex-wrap items-center lg:justify-center gap-3 2xl:gap-12 px-4 lg:px-8 2xl:px-16 3xl:px-32 ">
