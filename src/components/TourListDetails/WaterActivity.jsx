...
const WaterActivity = () => {
    return (
        <div className='py-10'>
            <h3 className="text-2xl mb-10 xl:text-4xl font-editorsNoteNormal text-primary text-center">
                ...
                <div className="bg-[#F1F1F1] rounded">
                    ...
                    <div className="flex p-5 items-center justify-between">
                        <div className="flex items-center gap-3">
                            <img src={watch} alt="" />
                            <p className="text-lg">2h 30m+</p>
                        </div>
                        <button className="bg-[#004265] text-white px-5 uppercase py-2 rounded-[2px]">view all</button>
                    </div>
                </div>
                <div className="bg-[#F1F1F1] rounded">
                    <img src={a2} alt="" />
