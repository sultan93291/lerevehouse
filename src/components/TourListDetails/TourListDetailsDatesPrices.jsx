          ...
          <div className="w-full h-auto py-10 xl:py-20 px-5 xl:px-10 bg-[#F4F4F4] flex flex-col gap-y-8  ">
            ...
            <div className="flex flex-col gap-y-3">
              <h2 className=" font-editorsNoteNormal font-medium  text-lg xl:text-xl leading-[150%] text-primary ">
                Exclusive: Everything not included in the list above. Price
                fixed <br /> subject to fluctuation not excedding 10 % + or - of
                the exchange rate fixed upon the recipt of the bank recipt
              </h2>
            </div>
          </div>
          {/* brochure */}
