  ...
  return (
    <div className="md:space-y-10 space-y-5">
      <div className="pb-6 border-b border-gray-200">
        <h3 className="font-fontSpring md:text-3xl text-2xl mb-2 text-[#004265]">
        ...
        <p className="text-[#565656] 2xl:text-xl lg:text-lg md:text-base text-sm">
          ...
          like the sweet and sour tom kaa soup, curries and pad Thai. Wine, beer
      ...
      <div className="pb-6 border-b border-gray-200">
        ...
        <p className="text-[#565656] 2xl:text-xl lg:text-lg md:text-base text-sm">
          ...
          a city that has long embraced Chinese cuisine as part of its culinary
      ...
      <div className="pb-6 border-b border-gray-200">
        ...
        <p className="text-[#565656] 2xl:text-xl lg:text-lg md:text-base text-sm">
          ...
          fans every year and features 30 to 40 concerts on eight outdoor
          stages.
        </p>
      </div>
      <div className="pb-6 border-b border-gray-200">
        ...
        <p className="text-[#565656] 2xl:text-xl lg:text-lg md:text-base text-sm">
          ...
          the shore or from a boat out on the water, this festival is a delight
          for all ages.
        </p>
      </div>
      <div className="pb-6 border-gray-200">
        ...
        <p className="text-[#565656] 2xl:text-xl xl:text-lg text-base">
          Like Montreal, Toronto and many other big cities across the globe,
          Vancouver celebrates diversity. A week of festivities culminates in a
          flamboyant parade stretching along two kilometres of city streets and
          attracting close to half a million spectators and participants..
        </p>
      </div>
    </div>
  );
