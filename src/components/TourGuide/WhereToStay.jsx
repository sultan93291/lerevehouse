    ...
    return (
        <div className="">
            ...
            <p className="text-[#565656] text-[15px] xs:text-base md:text-lg">
                ...
                and contemporary furnishings. A restaurant and bar specialize in Italian cuisine.
                Catering to guests in search of history and luxury, Palazzo Petrvs offers a central
                location for exploring Orvieto’s Etruscan roots.
            </p>
