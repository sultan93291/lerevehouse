  ...
  return (
    ...
    <div className="space-y-5 md:space-y-10">
      <div className="pb-4 md:pb-6 border-b border-gray-200">
        <h3 className="font-fontSpring md:text-3xl text-2xl mb-1 md:mb-3 text-[#004265]">
          Maenam
        </h3>
      ...
      <div className="pb-4 md:pb-6 border-gray-200">
        ...
        <p className="text-[#565656] 2xl:text-xl xl:text-lg text-[15px] xs:text-base">
          ...
          multitude of ways: sushi, oysters, caviar, fish, and so much more. The
          menu also includes meat and vegetarian options. Wine-lovers take note,
