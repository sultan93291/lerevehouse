    ...
    return (
        <section className="">
            <div className="container">
                ...
                <div className="row row-custom flex py-5 lg:py-0 flex-wrap ml-[-17px] mr-[-17px]">
                    {
                        holidaysData?.map((item) => (
                            <div key={item?.id} className="custom-column pl-[17px] pr-[17px] lg:pb-0 w-full sm:w-[50%] lg:w-[25%]">
                                <AdvanturePlaningCard item={item} />
                            </div>
                        ))
                    }
                </div>
                <div className="text-center sm:pt-5 pb-5 sm:pb-10 xs:py-10 lg:py-20 2xl:py-[120px] font-interTight text-[15px] xs:text-base lg:text-lg xl:text-xl 2xl:text-[24px]">
