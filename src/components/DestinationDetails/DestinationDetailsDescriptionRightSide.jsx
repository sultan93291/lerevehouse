    ...
    <div className=" w-full xl:w-1/2">
      <div className="bg-[#f4f4f4] p-4 md:p-8 xl:p-16 flex flex-col gap-10 items-center justify-center font-interTight">
        ...
        <div className="w-full font-interTight space-y-6">
          <Link className="block text-white text-sm lg:text-base text-center py-3 lg:py-4 border border-primary hover:bg-transparent hover:text-primary transition-all duration-300 w-full bg-primary">
            Make An Enquiry
          </Link>
